...
moduleForModel('i-i-s-proekt-na-generaciyu-должность', 'Unit | Serializer | i-i-s-proekt-na-generaciyu-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-proekt-na-generaciyu-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
