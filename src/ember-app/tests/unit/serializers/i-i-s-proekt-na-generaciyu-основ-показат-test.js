...
moduleForModel('i-i-s-proekt-na-generaciyu-основ-показат', 'Unit | Serializer | i-i-s-proekt-na-generaciyu-основ-показат', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-proekt-na-generaciyu-основ-показат',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
